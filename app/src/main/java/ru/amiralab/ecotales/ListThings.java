...
public class ListThings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_things);

        Intent Active = new Intent(this, MainActivity.class);

        FirebaseFirestore db = FirebaseFirestore.getInstance();

        RecyclerView recyclerViewT = findViewById(R.id.listThings);

        db.collection("stranger things")
                .get()
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            CustomClickListener customClickListener = itemId -> {
                                ...
                                i.putExtra("name", "stranger things");
